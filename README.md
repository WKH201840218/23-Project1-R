...
## #변수
<span style="color:blue">변수는 프로그램내에서 어떤 값을 저장해 놓을 수 있는 '보관상자'의 역할을 함</span>
...
### #자료형
<span style="color:blue">변수에 저장할 수 있는 값의 종류</span>
...
### #백터
<span style="color:blue">R에서 제공하는 여러 개의 값을 한꺼번에 저장하는 기능으로, 일반적인 프로그래밍 용어로는 1차원 배열이라고도 함</span>
