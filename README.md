...
## #패키지
<u>패키지는 소프트웨어 분야에서는 컴퓨터 이용자가 일상 업무에서 사용하는 응용 프로그램(application program)의 한 가지이며, 시판되고 있는 완성품 프로그램 또는 프로그램 집합체이다.</u>
...
## #변수
<u>변수는 프로그램내에서 어떤 값을 저장해 놓을 수 있는 '보관상자'의 역할을 함</u>
...
### #백터
<u>R에서 제공하는 여러 개의 값을 한꺼번에 저장하는 기능으로, 일반적인 프로그래밍 용어로는 1차원 배열이라고도 함</u>
